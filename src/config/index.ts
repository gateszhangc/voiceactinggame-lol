...
export const envConfigs: ConfigMap = {
  app_url: process.env.NEXT_PUBLIC_APP_URL ?? 'https://voiceactinggame.lol',
  app_name: process.env.NEXT_PUBLIC_APP_NAME ?? 'Voice Acting Game',
  app_description:
    process.env.NEXT_PUBLIC_APP_DESCRIPTION ??
    'Play voice acting games online: dub your own scenes, test your vocal range, scream-jump a chicken, run with a voice-controlled T-Rex and learn Mandarin with your voice.',
  app_logo: process.env.NEXT_PUBLIC_APP_LOGO ?? '/voiceactinggame/logo.svg',
  app_favicon:
    process.env.NEXT_PUBLIC_APP_FAVICON ?? '/voiceactinggame/favicon.svg',
  app_preview_image:
    process.env.NEXT_PUBLIC_APP_PREVIEW_IMAGE ??
    '/voiceactinggame/preview.png',
